...
const Header = () => {
    return (
        <div className={"h-screen pt-40 xl:flex-row flex flex-col justify-center items-center"}>
            {/*  Image section*/}
            <div
                className={" flex justify-center xl:justify-end items-center xl:w-3/4 w-screen xl:h-screen xl:pt-10 pt-32"}>
                <Image src={assets.sakuja_shamal} alt={"Sakuja Shamal"}
                       className={"rounded-full w-[240px] h-[220px]  xl:w-[380px] xl:h-[360px] p-2 hover:border-dashed hover:border-2 border-slate-500 transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110  "}/>
            </div>
            {/* Description*/}
