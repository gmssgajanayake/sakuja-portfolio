            ...
            <div className={" flex xl:justify-start justify-center items-center w-screen xl:h-screen  py-10 px-4"}>
                <div className={"xl:ml-4 flex justify-center items-center flex-col gap-4"}>
                    ...
                    <div className={"flex flex-col items-center justify-center"}>
                        <h2 className={"text-center text-xl text-center font-bold text-gray-600"}>Computer Science & Mathematics and Statistic
                            Student</h2>
                        <h2 className={"text-center text-lg font-normal text-gray-500"}>Following Bachelor's Science Degree </h2>
                    </div>
                    <div className={"flex gap-2 items-center justify-center"}>
                        <Image src={assets.uoj_loj} alt={"University of Jaffna Logo"} className={"w-6 h-6"}/>
                        <h3 className={"text-center font-normal  text-gray-500 text-sm"}>Undergraduate at University of Jaffna, Sri&nbsp;Lanka</h3>
                    </div>
